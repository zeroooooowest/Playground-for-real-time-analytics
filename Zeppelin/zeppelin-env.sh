...
# export ZEPPELIN_SSL_PORT=8443   		# ssl port (used when ssl environment variable is set to true)
...
export ZEPPELIN_WAR_TEMPDIR=webapps		# The location of jetty temporary directory.
export ZEPPELIN_NOTEBOOK_DIR=notebook	# Where notebook saved
# export ZEPPELIN_NOTEBOOK_HOMESCREEN		# Id of notebook to be displayed in homescreen. ex) 2A94M5J1Z
export ZEPPELIN_NOTEBOOK_HOMESCREEN_HIDE=false	# hide homescreen notebook from list when this value set to "true". default "false"

export ZEPPELIN_NOTEBOOK_S3_BUCKET=not        # Bucket where notebook saved
...
export ZEPPELIN_NOTEBOOK_ONE_WAY_SYNC=false	# If there are multiple notebook storages, should we treat the first one as the only source of truth?
...
export ZEPPELIN_DEP_LOCALREPO=local-repo
